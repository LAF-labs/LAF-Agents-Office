...
func TestBuildOfficeIntroLinesUsesWorkspaceState(t *testing.T) {
	...
	if !strings.Contains(plain, "Welcome to LAF-Office.") {
...
func TestBuildOfficeIntroLinesShowsOfflinePreviewGuidance(t *testing.T) {
	...
	if !strings.Contains(plain, "Launch LAF-Office to attach the live office, or run /doctor to inspect runtime readiness.") {
