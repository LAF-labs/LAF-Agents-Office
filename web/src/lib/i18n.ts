...
const messages = {
  en: {
    ...
    "sidebar.noAgentsOnline": "No agents online",
    "sidebar.newAgent": "New Agent",
    "sidebar.createAgent": "Create a new agent",
    "sidebar.invitePerson": "Invite Person",
    "sidebar.invitePersonTitle": "Invite a person",
    "sidebar.newChannel": "New Channel",
    "sidebar.createChannel": "Create a new channel",
    ...
    "tasks.taskQueueDesc":
      "Open, in-progress, review, pending, and blocked work.",
    "tasks.agentWork": "Agent work",
    "tasks.loadingAssignments": "Loading assignments...",
    "tasks.agentWorkDesc": "Work currently assigned away from the human owner.",
    ...
    "auth.title": "Start your AI office",
    "auth.desc":
      "Create an account or sign in, then choose the workspace your team will work from.",
    ...
    "auth.createAccountDesc":
      "Set up your login first, then choose how this account enters a workspace.",
    "auth.loginTitle": "Welcome back",
    "auth.loginDesc": "Log in to continue to your workspace.",
    "auth.accountSection": "Account",
    "auth.workspaceSection": "Workspace setup",
    "auth.workspaceDesc":
      "Create a workspace for your team, or join one with an invite.",
    "auth.createWorkspace": "Create a workspace",
    "auth.createWorkspaceDesc": "Start a new workspace for your team.",
    "auth.joinWorkspace": "Join with an invite",
    "auth.joinWorkspaceDesc": "Use an invite link or code from your team.",
  ...
  ko: {
    ...
    "sidebar.noAgentsOnline": "온라인 에이전트 없음",
    "sidebar.newAgent": "새 에이전트",
    "sidebar.createAgent": "새 에이전트 만들기",
    "sidebar.invitePerson": "팀원 초대",
    "sidebar.invitePersonTitle": "팀원 초대",
    "sidebar.newChannel": "새 채널",
    "sidebar.createChannel": "새 채널 만들기",
    "sidebar.active": "활성",
    "sidebar.open": "열림",
    ...
    "tasks.taskQueueDesc": "열림, 진행 중, 리뷰, 대기, 막힘 작업을 봅니다.",
    "tasks.agentWork": "에이전트 작업",
    "tasks.loadingAssignments": "담당 현황을 불러오는 중...",
    "tasks.agentWorkDesc": "사람이 아닌 에이전트에게 맡겨진 작업입니다.",
    ...
    "auth.kicker": "LAF-Office",
    "auth.title": "AI 오피스 시작하기",
    "auth.desc": "계정을 만들거나 로그인한 뒤 팀 워크스페이스를 선택하세요.",
    ...
    "auth.createAccountDesc":
      "먼저 로그인 계정을 만들고, 이 계정이 들어갈 워크스페이스를 선택합니다.",
    "auth.loginTitle": "다시 오셨군요",
    "auth.loginDesc": "계정으로 로그인해 워크스페이스로 이어서 들어갑니다.",
    "auth.accountSection": "계정 정보",
    "auth.workspaceSection": "워크스페이스 설정",
    "auth.workspaceDesc":
      "팀용 워크스페이스를 새로 만들거나 초대로 합류하세요.",
    "auth.createWorkspace": "워크스페이스 만들기",
    "auth.createWorkspaceDesc": "팀이 일할 새 공간을 시작합니다.",
    "auth.joinWorkspace": "초대로 합류",
    "auth.joinWorkspaceDesc": "초대 링크나 코드를 받은 경우 사용합니다.",
