...
test("Startup Office release gate points at loop engine tests", () => {
  ...
  assert.match(script, /api\/lib\/hosted\/apiEntrypoint\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/apiPrimitives\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/apiRouteDispatcher\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/activityHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/auditHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/auditWriter\.test\.js/);
  ...
  assert.match(script, /api\/lib\/hosted\/handlerBundle\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/ingressRateLimits\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/identityHandlerBundle\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/inviteEmailDelivery\.test\.js/);
  ...
  assert.match(script, /api\/lib\/hosted\/orchestrationHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/permissions\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/rateLimits\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/redaction\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/requestHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/requestIO\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/rosterHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/schedulerHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/securityHeaders\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/sessionCookies\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/serviceRoleAccess\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/skillHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/signupHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/supabaseAccess\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/teamPresentation\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/urlTrust\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/userContext\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/userPresentation\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/usageHandlers\.test\.js/);
  assert.match(script, /api\/lib\/hosted\/valueUtils\.test\.js/);
  ...
  assert.match(script, /api\/lib\/startup-office\/profileSeedHandlers\.test\.js/);
  assert.match(script, /api\/lib\/startup-office\/roleAuthorization\.test\.js/);
  assert.match(script, /api\/lib\/startup-office\/repositoryDelegates\.test\.js/);
  assert.match(script, /api\/lib\/startup-office\/routeHandlerMap\.test\.js/);
  assert.match(script, /api\/lib\/startup-office\/runtimeFactories\.test\.js/);
  ...
  assert.match(script, /api\/lib\/startup-office\/operationsStore\.test\.js/);
  assert.match(script, /api\/lib\/startup-office\/objectHandlerBundle\.test\.js/);
