...
const messages = {
  en: {
    ...
    "settings.section.runner": "LAF Bridge",
    ...
    "settings.bridge.helpOpenTerminal":
      "Open Terminal. On Mac, press Cmd + Space, type Terminal, then press Enter. On Linux, open the Terminal app.",
    "settings.bridge.helpCreateCopy":
      "Click Create setup command here. If the command is not copied automatically, click Copy command.",
    "settings.bridge.helpPasteEnter":
      "Paste into Terminal and press Enter. You do not need to understand the whole command; it installs LAF Bridge if needed and connects this computer.",
    ...
    "settings.bridge.generate": "Create setup command",
    "settings.bridge.generating": "Generating...",
    "settings.bridge.codeReady":
      "Setup command created. Click Copy command below.",
    "settings.bridge.generateFailed": "Failed to create setup command",
    ...
    "settings.runner.title": "LAF Bridge CLI Setup",
    "settings.runner.desc":
      "Use shell commands to let hosted projects run Codex CLI or Claude Code CLI on this machine.",
    "settings.runner.status": "Status",
    "settings.runner.connected": "LAF Bridge connected",
    "settings.runner.stale": "LAF Bridge needs attention",
    "settings.runner.disconnected": "LAF Bridge disconnected",
    "settings.runner.noRunner": "No LAF Bridge connected",
    "settings.runner.management": "LAF Bridge access",
    "settings.runner.managementHint":
      "Disconnect this computer from the workspace",
    "settings.runner.revoke": "Disconnect LAF Bridge",
    "settings.runner.revoked": "LAF Bridge disconnected.",
    "settings.runner.revokeFailed": "Failed to disconnect LAF Bridge.",
    "settings.runner.revokeTitle": "Disconnect LAF Bridge?",
    ...
    "settings.runner.optionalHint":
      "The workspace still works; Codex/Claude execution waits for LAF Bridge.",
    ...
    "settings.runner.connectionTitle": "LAF Bridge connection",
    "settings.runner.setupTitle": "Command-line setup",
    "settings.runner.setupDesc":
      "Run the install command on the Mac or Linux machine that should handle shared local CLI work. You can still use the hosted workspace without it.",
    "settings.runner.installCommandLabel": "Install command",
    "settings.runner.installCommandHint":
      "Run once on the runner machine; requires curl and a supported shell",
    "settings.runner.stepInstall": "Install with command",
    "settings.runner.stepCode": "Generate code",
    ...
    "settings.runner.commandLabel": "Connect command",
    "settings.runner.commandHint": "Run after generating the setup code",
    ...
    "sidebar.usagePersonalCli": "Personal CLI",
    ...
    "tasks.runnerChecking": "Checking LAF Bridge",
    "tasks.runnerConnected": "LAF Bridge connected",
    "tasks.runnerStale": "LAF Bridge stale",
  ...
  ko: {
    ...
    "settings.bridge.helpOpenTerminal":
      "터미널을 여세요. Mac에서는 Cmd + Space를 누르고 Terminal을 입력한 뒤 Enter를 누르면 됩니다. Linux에서는 Terminal 앱을 여세요.",
    "settings.bridge.helpCreateCopy":
      "여기에서 설정 명령 만들기를 누르세요. 자동으로 복사되지 않으면 명령 복사를 누르세요.",
    "settings.bridge.helpPasteEnter":
      "터미널에 붙여넣고 Enter를 누르세요. 명령 전체를 이해할 필요는 없습니다. 필요하면 LAF Bridge를 설치하고 이 컴퓨터를 연결합니다.",
    "settings.bridge.helpReturn":
    ...
    "settings.bridge.generate": "설정 명령 만들기",
    "settings.bridge.generating": "생성 중...",
    "settings.bridge.codeReady":
      "설정 명령이 생성되었습니다. 아래 명령 복사를 누르세요.",
    "settings.bridge.generateFailed": "설정 명령 생성 실패",
    ...
    "settings.runner.title": "LAF Bridge CLI 설정",
    "settings.runner.desc":
      "명령어로 이 컴퓨터의 Codex CLI 또는 Claude Code CLI를 호스팅 프로젝트에 연결합니다.",
    "settings.runner.status": "상태",
    "settings.runner.connected": "LAF Bridge 연결됨",
    "settings.runner.stale": "LAF Bridge 확인 필요",
    "settings.runner.disconnected": "LAF Bridge 연결 끊김",
    "settings.runner.noRunner": "연결된 LAF Bridge 없음",
    "settings.runner.management": "LAF Bridge 접근",
    "settings.runner.managementHint": "이 컴퓨터와 워크스페이스 연결 해제",
    "settings.runner.revoke": "LAF Bridge 연결 해제",
    "settings.runner.revoked": "LAF Bridge 연결을 해제했습니다.",
    "settings.runner.revokeFailed": "LAF Bridge 연결 해제 실패",
    "settings.runner.revokeTitle": "LAF Bridge 연결을 해제할까요?",
    "settings.runner.revokeMessage":
      "브라우저가 이 컴퓨터로 로컬 CLI 작업을 보내지 못하게 됩니다. 새 설정 코드로 다시 연결할 수 있습니다.",
    "settings.runner.revokeConfirm": "연결 해제",
    "settings.runner.optionalHint":
      "워크스페이스는 계속 사용할 수 있고, Codex/Claude 실행만 LAF Bridge 연결을 기다립니다.",
    ...
    "settings.runner.connectionTitle": "LAF Bridge 연결",
    "settings.runner.setupTitle": "명령어 설정",
    "settings.runner.setupDesc":
      "로컬 CLI 작업을 실행할 Mac 또는 Linux 머신에서 설치 명령을 실행하세요. LAF Bridge가 없어도 호스팅 워크스페이스는 사용할 수 있습니다.",
    "settings.runner.installCommandLabel": "설치 명령",
    "settings.runner.installCommandHint":
      "러너 머신에서 한 번 실행하세요. curl과 지원되는 셸이 필요합니다.",
    "settings.runner.stepInstall": "명령으로 설치",
    "settings.runner.stepCode": "코드 생성",
    ...
    "settings.runner.commandLabel": "연결 명령",
    "settings.runner.commandHint": "설정 코드를 만든 뒤 실행하세요",
    ...
    "sidebar.usagePersonalCli": "개인 CLI",
    "sidebar.usageLafAi": "LAF AI",
    ...
    "tasks.runnerChecking": "LAF Bridge 확인 중",
    "tasks.runnerConnected": "LAF Bridge 연결됨",
    "tasks.runnerStale": "LAF Bridge 응답 지연",
