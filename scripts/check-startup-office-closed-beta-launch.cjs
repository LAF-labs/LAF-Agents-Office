...
for (const [relativePath, snippets, label] of [
  ...
  [
    ...
    ["startup-office:citation-enforcement", "startup-office:closed-beta-launch", "startup-office:first-beta-smoke", "startup-office:live-model-smoke-check", "startup-office:memory-conflicts", "startup-office:memory-freshness", "startup-office:model-failover", "startup-office:production-handoff", "startup-office:provenance-replay", "startup-office:prompt-versions", "startup-office:receipt-integrity", "startup-office:retrieval-quality", "startup-office:tool-policy"],
