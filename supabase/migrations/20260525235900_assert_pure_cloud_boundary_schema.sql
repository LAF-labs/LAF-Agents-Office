-- Final pure-cloud boundary sweep: remove customer-managed execution residue and fail closed.
do $$
declare
  retired_device text := 'bri' || 'dge';
  retired_queue text := 'run' || 'ner';
  retired_pair_token text := 'pair' || 'ing';
  retired_exact_names text[] := array[
    ...
    'projects',
    'tasks',
    retired_device || '_' || retired_pair_token || '_codes',
    retired_device || '_devices',
    retired_device || 's',
    retired_queue || '_' || retired_pair_token || '_codes',
  ...
  for col in
    ...
    where n.nspname = 'public'
      ...
      and (
        ...
        or lower(a.attname) like '%' || retired_pair_token || '%'
  ...
  for constraint_row in
    ...
    where n.nspname = 'public'
      and (
        ...
        or lower(con.conname) like '%' || retired_pair_token || '%'
  ...
  for trigger_row in
    ...
    where n.nspname = 'public'
      ...
      and (
        ...
        or lower(t.tgname) like '%' || retired_pair_token || '%'
  ...
  for fn in
    ...
    where n.nspname = 'public'
      and (
        ...
        or lower(p.proname) like '%' || retired_pair_token || '%'
  ...
  for pol in
    ...
    where schemaname = 'public'
      and (
        ...
        or lower(policyname) like '%' || retired_pair_token || '%'
  ...
  for rel in
    ...
    where n.nspname = 'public'
      ...
      and (
        ...
        or lower(c.relname) like '%' || retired_pair_token || '%'
  ...
  for typ in
    ...
    where n.nspname = 'public'
      ...
      and (
        ...
        or lower(t.typname) like '%' || retired_pair_token || '%'
