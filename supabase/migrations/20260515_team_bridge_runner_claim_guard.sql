create index if not exists idx_runner_jobs_claim_team_bridge
  on public.runner_jobs(team_id, status, model_mode, provider_kind, lease_expires_at, created_at);
