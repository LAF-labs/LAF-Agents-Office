...
export const STARTUP_OFFICE_APP_COPY = {
  en: {
    ...
    acceptTerms: "Accept beta terms",
    acceptingTerms: "Accepting",
    termsAccepted: "Beta terms accepted.",
    termsAcceptedStatus: "Accepted",
    termsMissing: "Not accepted",
  ...
  ko: {
    ...
    acceptTerms: "베타 약관 수락",
    acceptingTerms: "수락 중",
    termsAccepted: "베타 약관을 수락했습니다.",
    termsAcceptedStatus: "수락됨",
    termsMissing: "미수락",
